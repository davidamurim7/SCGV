 ...
 * @author David
 */
public class DExcProdutoCaixa extends javax.swing.JDialog {
    ...
    /**
     * Creates new form DExcProdutoCaixa
     */
    public DExcProdutoCaixa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Excluir Produto da Venda");
        setResizable(false);

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel2.setText("Excluir Produto da Venda");
        ...
        quantidadeT.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        quantidadeT.setText(" - ");
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(quantidadeT, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))))
                        .addGap(26, 26, 26))
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void confirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmarActionPerformed
        for(Vendido pv : telaPrincipalCaixa.listaProdutosVendidosBackup){
            if(pv.getIdProduto() == idProdudoSelecionado){
                telaPrincipalCaixa.listaProdutosVendidosBackup.remove(pv);
        ...
        if(codigoT.getText().trim().equals("")){
            ...
            for(Vendido pv : telaPrincipalCaixa.listaProdutosVendidosBackup){
                ...
                if(produto.getCodigo().trim().equals(codigoT.getText().trim())){
                    ...
                    quantidadeT.setText(String.valueOf(pv.getQuantidade()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DExcProdutoCaixa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DExcProdutoCaixa dialog = new DExcProdutoCaixa(new javax.swing.JFrame(), true);

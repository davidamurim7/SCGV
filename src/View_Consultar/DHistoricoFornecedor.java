 ...
 * @author David
 */
public class DHistoricoFornecedor extends javax.swing.JDialog {
     ...
     */
    public DHistoricoFornecedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void preencheTabela(){
        ...
        DefaultTableModel model = (DefaultTableModel) tabHistoricoFornecedores.getModel();
        while(model.getRowCount() > 0)
            model.removeRow(0);
        int i = 0;
        listaHistorico = historicoDAO.listarHistorico(1);
        for(Historico h : listaHistorico){
            if(Metodos.transDataIngPort(h.getData()).contains(filtro)){
                model.addRow(new String[i]);
                tabHistoricoFornecedores.setValueAt(Metodos.transDataIngPort(h.getData()), i, 0);
                tabHistoricoFornecedores.setValueAt(funcionarioDAO.selecionarFuncionario(h.getIdFuncionario()).getNome(), i, 1);
                tabHistoricoFornecedores.setValueAt(h.getDescricao(), i, 2);
                i++;
            }
        }
    ...
    private void initComponents() {
        ...
        tabHistoricoFornecedores = new javax.swing.JTable();
        ...
        setTitle("Histórico de Fornecedores");
        setResizable(false);

        jPanel7.setBackground(new java.awt.Color(255, 255, 255));

        tabHistoricoFornecedores.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
        ...
        tabHistoricoFornecedores.getTableHeader().setReorderingAllowed(false);
        jScrollPane2.setViewportView(tabHistoricoFornecedores);

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel2.setText("Histórico de Fornecedores");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DHistoricoFornecedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DHistoricoFornecedor dialog = new DHistoricoFornecedor(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable tabHistoricoFornecedores;

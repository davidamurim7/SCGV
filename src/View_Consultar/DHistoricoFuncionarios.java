 ...
 * @author David
 */
public class DHistoricoFuncionarios extends javax.swing.JDialog {
     ...
     */
    public DHistoricoFuncionarios(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void preencheTabela(){
        ...
        DefaultTableModel model = (DefaultTableModel) tabHistoricoFuncionarios.getModel();
        while(model.getRowCount() > 0)
            model.removeRow(0);
        int i = 0;
        listaHistorico = historicoDAO.listarHistorico(3);
        for(Historico h : listaHistorico){
            if(Metodos.transDataIngPort(h.getData()).contains(filtro)){
                model.addRow(new String[i]);
                tabHistoricoFuncionarios.setValueAt(Metodos.transDataIngPort(h.getData()), i, 0);
                tabHistoricoFuncionarios.setValueAt(funcionarioDAO.selecionarFuncionario(h.getIdFuncionario()).getNome(), i, 1);
                tabHistoricoFuncionarios.setValueAt(h.getDescricao(), i, 2);
                i++;
            }
        }
    ...
    private void initComponents() {
        ...
        tabHistoricoFuncionarios = new javax.swing.JTable();
        ...
        setTitle("Histórico de Funcionários");
        setResizable(false);

        jPanel7.setBackground(new java.awt.Color(255, 255, 255));

        tabHistoricoFuncionarios.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
        ...
        tabHistoricoFuncionarios.getTableHeader().setReorderingAllowed(false);
        jScrollPane2.setViewportView(tabHistoricoFuncionarios);

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel2.setText("Histórico de Funcionários");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DHistoricoFuncionarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DHistoricoFuncionarios dialog = new DHistoricoFuncionarios(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable tabHistoricoFuncionarios;
